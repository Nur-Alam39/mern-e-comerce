...
// NOTE: previously a global console.warn suppression lived here; we've removed it
// so that findDOMNode deprecation messages surface. ReactQuill instances in this
// app are given refs directly (see `quillRef`) to avoid findDOMNode usage.
...
export default function AdminPageEdit() {
    ...
    const fetchPage = async (pageId) => {
        ...
        } catch (err) { console.log('Load page failed', err); }
    };
                ...
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-3">
                            ...
                            <button type="button" className="btn btn-secondary ms-2" onClick={() => navigate('/admin?section=pages')}>Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
